...
static CFTimeInterval const kDefaultWaitAnimationDuration = 2.0;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        self.backgroundColor = [UIColor colorWithRed:19/255.0 green:139/255.0 blue:130/255.0 alpha:1];
